...
public class LavaEnemyRange : MonoBehaviour
{
    [Header("Settings")]
    ...
    private IEnumerator DelayedShoot(Transform target)
    {
        ...
        GameObject fireball = Instantiate(arrowPrefab, shootPoint.position, Quaternion.identity);
        fireball.GetComponent<FireBall>().Initialize(direction, damage);
    }
